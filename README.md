...
Via jsdelivr:
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gridlex/2.2.0/gridlex.min.css">
```
...
Columns can be hidden at breakpoints using `_*-0` (e.g. `col-4_md-6_sm-0` or `col-3_xs-0`)
<table>
<thead>
	<tr>
